...
class JobSeekerWebAdapterTest {
    ...
    private final ISearchJobSeekerService searchJobSeekerService = mock(ISearchJobSeekerService.class);
    private final JobSeekerWebAdapter adapter = new JobSeekerWebAdapter(getAllJobSeekerService, saveJobSeekerService, searchJobSeekerService);
